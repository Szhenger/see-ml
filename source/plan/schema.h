...
// v14: the GEMM addend (E10) — kFlagGemmAddend on the f32 GEMMs (kGemmNN,
// kGemmNT, kGemmTN), C = D + A@B with D in the free in[3]. Additive, one
// flag bit, rejected below v14; bit-identical to the GEMM + kAddEW pair it
// replaces.
