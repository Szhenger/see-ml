#ifndef SEEML_COMPILER_BACKEND_ARCHITECTURE_KERNEL_EMITTER_H_
#define SEEML_COMPILER_BACKEND_ARCHITECTURE_KERNEL_EMITTER_H_
...
#endif  // SEEML_COMPILER_BACKEND_ARCHITECTURE_KERNEL_EMITTER_H_
