#ifndef SEEML_COMPILER_FRONTEND_ACCOUNTANT_RESOURCE_ANALYZER_H_
#define SEEML_COMPILER_FRONTEND_ACCOUNTANT_RESOURCE_ANALYZER_H_
...
#endif  // SEEML_COMPILER_FRONTEND_ACCOUNTANT_RESOURCE_ANALYZER_H_
