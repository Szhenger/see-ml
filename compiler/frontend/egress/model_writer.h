#ifndef SEEML_COMPILER_FRONTEND_EGRESS_MODEL_WRITER_H_
#define SEEML_COMPILER_FRONTEND_EGRESS_MODEL_WRITER_H_
...
#endif  // SEEML_COMPILER_FRONTEND_EGRESS_MODEL_WRITER_H_
