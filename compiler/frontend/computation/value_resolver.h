#ifndef SEEML_COMPILER_FRONTEND_COMPUTATION_VALUE_RESOLVER_H_
#define SEEML_COMPILER_FRONTEND_COMPUTATION_VALUE_RESOLVER_H_
...
#endif  // SEEML_COMPILER_FRONTEND_COMPUTATION_VALUE_RESOLVER_H_
